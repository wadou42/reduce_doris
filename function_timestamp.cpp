...
struct StrToDateDataTypeDate {
    ...
    static DataTypePtr get_return_type_impl(const DataTypes& arguments) {
        if constexpr (IsDataTypeDateTimeV2<DataTypeDate>) {
            // max scale
...
struct StrToDateDataTypeDateTime {
    static constexpr auto name = "str_to_date";
    ...
    static DataTypePtr get_return_type_impl(const DataTypes& arguments) {
        if constexpr (IsDataTypeDateTimeV2<DataTypeDateTime>) {
            // max scale
            return make_nullable(std::make_shared<DataTypeDateTimeV2>(6));
        }
...
struct StrToDateDataTypeDateV2 {
    static constexpr auto name = "str_to_date";
    ...
    static DataTypePtr get_return_type_impl(const DataTypes& arguments) {
        if constexpr (IsDataTypeDateTimeV2<DataTypeDateV2>) {
            // max scale
            return make_nullable(std::make_shared<DataTypeDateTimeV2>(6));
        }
...
struct StrToDateDataTypeDateTimeV2 {
    static constexpr auto name = "str_to_date";
    ...
    static DataTypePtr get_return_type_impl(const DataTypes& arguments) {
        if constexpr (IsDataTypeDateTimeV2<DataTypeDateTimeV2>) {
            // max scale
            return make_nullable(std::make_shared<DataTypeDateTimeV2>(6));
        }
...
using FunctionStrToDate = FunctionOtherTypesToDateType<StrToDateDataTypeDate>;
using FunctionStrToDatetime = FunctionOtherTypesToDateType<StrToDateDataTypeDateTime>;
using FunctionStrToDateV2 = FunctionOtherTypesToDateType<StrToDateDataTypeDateV2>;
using FunctionStrToDatetimeV2 = FunctionOtherTypesToDateType<StrToDateDataTypeDateTimeV2>;
